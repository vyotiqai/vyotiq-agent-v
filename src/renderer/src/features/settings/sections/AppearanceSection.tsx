    ...
    <SettingsStack>
      <SettingsGroup title="Skin">
        <SettingsField
          ...
          help="Default ships the Azure instrument look. Proof uses dusk, Bench neon blue, Native a branding-orange accent, and Gild a blue-slate palette on alabaster and onyx."
          wide
        >
