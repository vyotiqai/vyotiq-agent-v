...
Download the installer for Windows, macOS, or Linux from [https://vyotiq.com](https://vyotiq.com).
...
The full contribution workflow (typecheck, lint, tests) is described in [CONTRIBUTING.md](CONTRIBUTING.md).
